...
public class BankGridViewAdapter extends ArrayAdapter<Banks> {

    public BankGridViewAdapter(Context context, int resource, List<Banks> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == v) {
            ...
            v = inflater.inflate(R.layout.bankgrid_item, null);
        }
